...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		slicedCols			: 10,	//if 0 the same value of cols
...
////////callbacks
	...
	if(elem.length!=0){
		...
		if(navHover==true){
			$(prevNav,wrap).stop().animate({opacity:0},0);
			$(nextNav,wrap).stop().animate({opacity:0},0);
			if(isMobile()){
				$(document).on('vmouseover',fakeHoverSelector,function(){
					$(prevNav,wrap).stop().animate({opacity:1},200);
					$(nextNav,wrap).stop().animate({opacity:1},200);
				});
				$(document).on('vmouseout',fakeHoverSelector,function(){
					$(prevNav,wrap).delay(500).stop().animate({opacity:0},200);
					$(nextNav,wrap).delay(500).stop().animate({opacity:0},200);
				});
			} else {
				fakeHover.hover(function(){
					$(prevNav,wrap).stop().animate({opacity:1},200);
					...
					$(prevNav,wrap).stop().animate({opacity:0},200);
					$(nextNav,wrap).stop().animate({opacity:0},200);
				});
			}
		}
