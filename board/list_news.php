					...
					<td align='right'>
						<table cellpadding='0' cellspacing='0' border='0'>
							<tr>
								...
								<td><label for="word"><input name="word" type="text" value='<?=$word?>' onkeypress="if(event.keyCode==13){goSearch();}"></label></td>
								<td><a href="javascript:goSearch();" class="scbtn"><img src="/images/scbtn.png" alt="" style="max-width:20px;"></a></td>
							</tr>
						</table>
					</td>
				</td>
...
?>
				<tr <?=$bgcolor?> height='65'> 
					...
					<td width="*" class='b-text-s' style='padding:5px;'><a href="<?=$sDataUrl?>" target="_blank"><span class='ico10'>원문보기</span> <span class='board1'><?=$title?></span></a></td>
