<?
//권한종류
$sel_chk01 = Array('전체','관리자','게시물관리자','일반');
...
//게시판 버튼이미지 설정
$BTN_qimg = $boardRoot.'img/'.$ImgPath.'/q_img2.png';	 //질문아이콘
$BTN_aimg = $boardRoot.'img/'.$ImgPath.'/a_img2.png';	 //답변아이콘
...
<label for="file_name"><input type='hidden' name='file_name' value=""></label>
<label for="file_rename"><input type='hidden' name='file_rename' value=""></label>
</form>
