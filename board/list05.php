...
?>
				...
				<tr <?=$bgcolor?> height='65' class='<?=$qna_box?>'> 
					<td width='85' align='center'><img src="<?=$BTN_qimg?>"></td>
					<td width='715' style='padding-left:5px;' class='b-text'><?=$btn_tit_view?></td>
				...
				<tr id='a_ment<?=$line_num?>' style="display:none" <?=$bgcolor?> class='<?=$qna_box?>'> 
					...
					<td style='padding:50px 5px;background:#f1f3f7' colspan='3'><span class='board1 b-text-s' style='line-height:20px;'><?=$ment?></span></td>
				</tr>
...
?>
				...
				<tr id='a_ment<?=$line_num?>' style="display:none" <?=$bgcolor?> class='<?=$qna_box?>'> 
					<td align='center' style='background:#f1f3f7'><img src="<?=$BTN_aimg?>"></td>
					<td style='padding:50px 5px;background:#f1f3f7'><span class='board1 b-text-s' style='line-height:20px;'><?=$ment?></span></td>
				</tr>
