			...
			<table class="gal-tbl" cellpadding='0' cellspacing='0' border='0' width='100%'>
				<tr>
					...
					<td width='50%' align='right' style='padding-bottom:20px;'>
						...
						<label for="word"><input name="word" type="text" style='width:200px;height:30px;border:1px solid #dddddd;border-radius:3px;padding:5px;' value='<?=$word?>'></label>
...
*/
		...
		$userfile = "<img src='".$geturl."' class='grow' alt=''>";
