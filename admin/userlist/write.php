...
<form name='frm_filedown' method='post'>
	<input type='hidden' name='downfiledir' value='../../upfile/user/'>
...
<input type='hidden' name='realfile02' id='realfile02' value='<?=$realfile02?>'>
<input type='hidden' name='oldUser' value='<?=$oldUser?>'>

<input type='hidden' name='opoint' value='<?=$point?>'><!-- 수정전 적립금 -->
			...
			<td colspan='3'>
				<table cellpadding='0' cellspacing='0' border='0'>
					<tr>
						<td>
							<div class="squaredThree" id='sexBox'>
								<input type="checkbox" value="일반" id="jT3" name="userType" onclick='setChkBox(this.name,0);' <?if($userType == '일반'){echo 'checked';}?>>
								<label for="jT3"></label>
							</div>
							<p style='margin:3px 0 0 25px;' class='status2'>일반회원</p>
						</td>
						<td style='padding:0 0 0 25px;'>
							<div class="squaredThree">
								<input type="checkbox" value="약사" id="jT4" name="userType" onclick='setChkBox(this.name,1);' <?if($userType == '약사'){echo 'checked';}?>>
								<label for="jT4"></label>
							</div>
							<p style='margin:3px 0 0 25px;' class='status3'>약사회원</p>
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			...
			<td colspan='3'>
				<table cellpadding='0' cellspacing='0' border='0'>
					<tr>
						<td>
							<div class="file_input" style='width:360px;'>
								<input type="text" readonly title="File Route" id="file_route01" style="width:250px;padding:0 0 0 10px;" placeholder="사업자등록증 서류를 첨부해주세요.">
			...
			<td colspan='3'>
				<table cellpadding='0' cellspacing='0' border='0'>
					<tr>
						<td>
							<div class="file_input" style='width:360px;'>
								<input type="text" readonly title="File Route" id="file_route02" style="width:250px;padding:0 0 0 10px;" placeholder="약사면허증 서류를 첨부해주세요.">
...
<!-- 
 ...
 -->
		...
		<tr>
			<th>포인트</th>
			<td colspan='3'><input name="point" id="point" style="width:100px;" type="text" value="<?=$point?>"> 포인트</td>
		</tr>
