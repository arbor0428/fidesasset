...
function check_form(){
	...
	if(form.sms.checked == true){
		if(isFrmEmpty(form.ship_num,"문자발송을 위한 송장번호를 입력해 주십시오"))	return;
	}
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class='gTable2'>
				<tr height='40'> 
					...
					<td width="33%" class='tab'>
						<select name='set_status' id='set_status' style='height:30px;padding:5px;font-size:13px;' onchange='cDateBox();'>
				...
				<tr height='40'> 
					...
					<td class='tab'>
						<table cellpadding='0' cellspacing='0' border='0'>
							<tr>
								<td><input type='text' name='ship_num' value='<?=$ship_num?>' style='width:100px;'></td>
