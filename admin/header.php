...
<table cellpadding='0' cellspacing='0' border='0' width='100%'  style="height: 100vh;">
	<tr>
		<td colspan='2' height='80' style="background:#333;">
			<table cellpadding='0' cellspacing='0' border='0' width='100%' align='center'>
				<tr>
					<td width='200' align='center'><a href='/' onfocus='this.blur();' class="top_m" target='_top'><img src="/images/f_logo.png"></a></td>
					<td align='right'>
