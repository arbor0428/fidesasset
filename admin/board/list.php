...
<table cellpadding='0' cellspacing='0' border='0' width='100%'>
	<tr style="height: 70px;">
		...
		<td height='30' align='right'>
			...
			<input name="word" type="text" size="20" value='<?=$word?>'> <a href='javascript:document.frm01.submit();' style="position:relative; top: 2px; padding: 7px 20px; background-color: #000; color: #fff;">검색</a>
		</td>
	</tr>
	<tr>
		<td colspan='2'>
...
?>
				...
				<tr> 
					...
					<td align='center'><a href="javascript:reg_modify('<?=$uid?>');"><img src="/images/common/modify.gif" alt="수정" width="50" height="21"></a> <a href="javascript:click_del('<?=$title?>','<?=$uid?>')"><img src="/images/common/delete.gif" alt="삭제" width="50" height="21"></a></td>
				</tr>
<?
		$i--;
		$line_num++;
