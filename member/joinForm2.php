...
<div>
	...
	?>
		...
		<li class="mr">
			<div class="formttl1">비밀번호<span style="font-size:13px;font-weight:400">&nbsp;(6자 ~ 10자 이내)</span></div>
			<div><input name="pwd" id="pwd" class="ip_1" style="width:100%;" type="password" onkeyup='pwdChk();'></div>
		</li>
		
		<li>
			<div class="formttl1">비밀번호 확인</div>
			<div><input class="ip_1" name="re_pwd" id="re_pwd" style="width:100%;" type="password" onkeyup='pwdChk();'> <span id='pwdTxt'></span></div>
		</li>
	...
	?>
		...
		<li>
			<div class="formttl1">비밀번호</div>
			<div><input class="ip_1" name="pwd" id="pwd" style="width:250px;" type="password" value="<?=$pwd?>"> <span style="font-size:13px;">※ 6자 ~ 10자 이내</span></div>
		</li>
	<?
		}
	?>
		...
		<li class="mr">
			<div class="formttl1">회원명</div>
			<div><input class="ip_1" name="name" id="name" style="width:100%;" type="text" value="<?=$name?>"></div>
		</li>

		<li>
			<div class="formttl1">회원번호<span style="font-size:13px;font-weight:400">&nbsp;(기존 가입자용)</span></div>
			<div style="width:100%;background:#f8f7f9;height:44px;line-height:44px;border:1px solid #d2d2d2"><span id='userNumTxt'><?=$userNum?></span><input class="ip_1" type='hidden' name='userNum' id='userNum' value='<?=$userNum?>'></div>
		</li>

		<li class="mr chk_iro clearfix">
			<div class="formttl1">성별</div>
		...
		<li>
			<div class="formttl1">생년월일</div>
			<div ><input style='border:1px solid #ccc;height:46px;background:#fff;width:100%' type='text' name='bDate' id='fpicker1' value='<?=$bDate?>' readonly></div>
		</li>

		<li class="li100 chk_iro clearfix">
			<div class="formttl1">감면대상자 구분</div>
		...
		<li class="li100">
			<div>
			<input class="ip_1 add001" name="addr01" id="addr01" type="text" value="<?=$addr01?>" placeholder="기본주소">
			<input class="ip_1 add002" name="addr02" id="addr02" type="text" value="<?=$addr02?>" placeholder="상세주소">
			</div>
		</li>

		<li class="li100">
			<div class="formttl1">이메일</div>
			<div>
				...
				<select class="ipmt10" style='border:1px solid #ccc;height:46px;' onchange="document.FRM.email02.value=this.options[this.selectedIndex].value;">
		...
		<li>
			<div class="formttl1">연락처1</div>
			<div class="clearfix">
				<input class="ip_1" name="phone01" id="phone01" style="width:150px;float:left;" type="text" value="<?=$phone01?>" placeholder="연락처">
				<select name="phone01Txt" id="phone01Txt" style="float:left;border:1px solid #ccc;height:46px;">
...
?>
		...
		<li>
			...
			<div class="clearfix">
				...
				<select name="phone02Sel" id="phone02Sel" style="float:left;border:1px solid #ccc;height:46px;" onchange="phone02Box();">
					<option value="">:: 선택 ::</option>
...
-->
		<li class="li100 chk_iro clearfix" id='cokBox'>
			...
			<div class="vms_wrap clearfix chanel00" id="sTypeBox">
					<label class="male ss1 cms2" for="cC2">
					<input required type="checkbox" value="문자메세지" id="cC2" name="cokSms" onclick='setClickBox(this.name);' <?if($cokSms){echo 'checked';}?>><div class="box_radio nrb bdtn mbdr">문자메세지</div>
					</label>

					<label class="female ss1 dangi cms2" for="cC3">
					...
					<input required type="checkbox" value="전화" id="cC4" name="cokPhone" onclick='setClickBox(this.name);' <?if($cokPhone){echo 'checked';}?>><div class="box_radio nrb bdtn mbdr">전화</div>
					</label>
				</div>
...
?>	
	...
	<div class="subcon_ttl w100">
		...
		<div class="sut_02"><img src="/img/m_circle.png" alt="" /></div>
	</div>
	...
	<div class="con_margin20"></div>
		<div class="agree_form01 bgc_fff bdtb"  style="background:#f9f9f9">
			...
			광교종합사회복지관 홈페이지의 기능관련하여 정상적인 서비스 제공이 불가능 할 수 있음을 알려드립니다.</span>
		</div>
		...
		<div class="con_margin40"></div>
			...
			<div class="con_margin20"></div>
			<textarea class="agree_form01 bgc_fff bdtb"  style="height:200px;border-right:none;border-left:none;background:#f9f9f9;resize:none;"><?include 'policy2.php'?></textarea>
			<div class="agree_wrap clearfix">
				<div class="fr">
					<div class="squaredThree">
