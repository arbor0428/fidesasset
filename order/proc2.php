...
*/
	...
	$sql .= "values ('$userid','$oname','$ozip1','$ozip2','$ozipcode','$oaddr1','$oaddr2','$otel1','$otel2','$otel3','$ohp1','$ohp2','$ohp3','$oemail','$pname','$pzip1','$pzip2','$pzipcode','$paddr1','$paddr2','$ptel1','$ptel2','$ptel3','$php1','$php2','$php3','$ment','-','$ac_name','$result_price','$ship_price','$ship_mode','$ship_num','$amt','$cChk','$couponTxt','$uPrice','결제완료','$user_ip','$reg_date')";
	$result = mysql_query($sql);
