...
function setAmt(){
	...
	//감면액
	rate = $('#rate').val();
	if(rate)	saleTot = Math.round(programTot * (rate/100));
...
<table cellpadding='0' cellspacing='0' border='0' width='100%' class='gTable' style='margin-top:30px;background-color:#fff'>
	<tr height='50'>
		<th width='30%'><span class='required'>*</span>결제수단</th>
		<td width='70%'>
