...
function setcart(type,uid,cade01){
	...
	document.getElementById("Divtot").innerHTML = "(총수량 : "+number_format(TeT)+" EA / 왕복배송비 : "+number_format(Sprice)+"원)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[총계]&nbsp;<span class='font_red'>"+number_format(LastTotal01)+"원</span>";
...
?>
				...
				<tr>
					<td colspan="7" height="30" align="right" style='padding-right:10px;font-weight:bold;'><div id='Divtot' class='txt_pro'>(총수량 : <?=$tot_ea?> EA / 왕복배송비 : <?=$spTxt?>원)&nbsp;<?=$shiptxt?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[총계]&nbsp;<span class="font_red"><?=number_format($amt)?>원</span></div></td>
				</tr>
