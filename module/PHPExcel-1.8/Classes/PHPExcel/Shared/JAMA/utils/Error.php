...
$error['FR'][POLYMORPHIC_ARGUMENT_EXCEPTION] = "Mod챔le inadmissible d'argument pour la fonction polymorphe.".
$error['DE'][POLYMORPHIC_ARGUMENT_EXCEPTION] = "Unzul채ssiges Argumentmuster f체r polymorphe Funktion.";
...
$error['DE'][ARGUMENT_TYPE_EXCEPTION] = "Unzul채ssige Argumentart.";
...
$error['DE'][ARGUMENT_BOUNDS_EXCEPTION] = "Unzul채ssige Argumentstrecke.";

define('MATRIX_DIMENSION_EXCEPTION', -4);
$error['EN'][MATRIX_DIMENSION_EXCEPTION] = "Matrix dimensions are not equal.";
$error['FR'][MATRIX_DIMENSION_EXCEPTION] = "Les dimensions de Matrix ne sont pas 챕gales.";
$error['DE'][MATRIX_DIMENSION_EXCEPTION] = "Matrixmae sind nicht gleich.";

define('PRECISION_LOSS_EXCEPTION', -5);
$error['EN'][PRECISION_LOSS_EXCEPTION] = "Significant precision loss detected.";
$error['FR'][PRECISION_LOSS_EXCEPTION] = "Perte significative de pr챕cision d챕tect챕e.";
$error['DE'][PRECISION_LOSS_EXCEPTION] = "Bedeutender Pr채zision Verlust ermittelte.";
...
$error['FR'][MATRIX_SPD_EXCEPTION] = "Perte significative de pr챕cision d챕tect챕e.";
$error['DE'][MATRIX_SPD_EXCEPTION] = "Bedeutender Pr채zision Verlust ermittelte.";
