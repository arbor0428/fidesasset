...
//	$license = "C:\\okcert3_license\\".$CP_CD."_IDS_01_".$target."_AES_license.dat";
	$license = "/home/austin/www/module/kcb/mobile/".$CP_CD."_IDS_01_".$target."_AES_license.dat";
	...
	**************************************************************************/
	...
	$sql .= "('mobile','$TX_SEQ_NO','$RSLT_CD','$RSLT_MSG','$RSLT_NAME','$RSLT_BIRTHDAY','$RSLT_SEX_CD','$RSLT_NTV_FRNR_CD','$TEL_COM_CD','$TEL_NO','$RETURN_MSG','$userip','$rDate','$rTime')";
