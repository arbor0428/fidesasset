...
<script src="//i-web.kr/module/js/datepicker.js"></script>

<style>
.fpicker, .cpicker, #fpicker1, #fpicker2, #fpicker3, #fpicker4, #fpicker5, #fpicker6, #fpicker7, #bDate{
...
.ui-datepicker select.ui-datepicker-month{width:37%;font-size:14px;}
...
$(function(){
	$( ".fpicker, .cpicker, #fpicker1,#fpicker2,#fpicker3,#fpicker4,#fpicker5,#fpicker6,#fpicker7,#bDate" ).datepicker({
...
$(document).ready(function () {
	$('.cpicker, #fpicker1,#fpicker2,#fpicker3,#fpicker4,#fpicker5,#fpicker6,#fpicker7').prop('readonly', true);

	$(document).find(".cpicker").removeClass('hasDatepicker').datepicker({
		dateFormat: 'yy-mm-dd',
		prevText: '이전 달',
		nextText: '다음 달',
		monthNames: ['1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월'],
