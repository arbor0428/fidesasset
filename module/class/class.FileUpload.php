...
class FileUpload
{
	...
	function FileUpload($directory, $http_file_name, $code='', $limit_size=15, $extension=array('gif','jpg','jpeg','bmp','png','swf','doc','docx','txt','pdf','xls','xlsx','hwp','ico','wmv','wma','mp3','dwg','dxf','ai','ppt','pptx','zip')){
