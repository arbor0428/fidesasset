<?
    ...
    /* ============================================================================== */
    $g_conf_home_dir  = "/home/austin/www/module/kcp";       // BIN 절대경로 입력 (bin전까지) 
...
if($_SERVER['REMOTE_ADDR'] == '106.246.92.2371'){
    ...
    /* =   log 경로 지정                                                            = */
    /* ============================================================================== */
    $g_conf_log_path = "/home/austin/www/module/kcp/bin/log";
...
if($_SERVER['REMOTE_ADDR'] == '106.246.92.2371'){
    ...
    $g_conf_site_cd   = "A8UQL";
    $g_conf_site_key  = "0fFSKEXFXXg6LbJ7bMOvWKu__";
}
