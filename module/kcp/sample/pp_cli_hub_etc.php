...
<?
    ...
    if ( $req_tx == "pay" )
    {
			...
			$sql = "select * from ks_programEtcTmp where userip='$cust_ip' and rTime='$ordr_idxx'";
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <form name="pay_info" method="post" action="/mypage/etc.php?type=view&uid=<?=$uid?>">
