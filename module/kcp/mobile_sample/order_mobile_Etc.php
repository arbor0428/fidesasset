...
<?
	...
	$sql = "insert into ks_programEtcTmp (pid,saleAmt,kcpAmt,payMode,userid,userip,rDate,rTime,UserOS) values ";
	$sql .= "('$uid','$saleAmt','$kcpAmt','$payMode','$userid','$userip','$rDate','$rTime','$UserOS')";
	$result = mysql_query($sql);

	$chr30 = chr(30);
	$chr31 = chr(31);

	$good_info = 'seq=1'.$chr31.'ordr_numb='.$uid.$chr31.'good_name='.$uid.$chr31.'good_cntx=1'.$chr31.'good_amtx='.$kcpAmt;
...
<form name="pay_form" method="post" action="pp_cli_hub_etc.php">
