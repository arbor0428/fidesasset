<?
	...
	if($authflag == 'A'){
		...
		$sql = "insert into kcp_pos (noticode,proccode,amt1,amt2,amt3,amt4,amt5,tsddate,tsdtime,posentry,cdno,mtrsno,termid,bid,taxno,istmmon,authno,authflag,authdate,authtime,hid,acqhid,cardflag,acctype,orgauthdate,orgauthno,termname,payTime,rDate,rTime) values ";
